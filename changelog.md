...
## react-markdown-encoder 0.1.1 - 2026-05-20
...
* Bundle the published package entry for package-manager link workflows and
  avoid Node-specific imports in browser-oriented bundlers.
